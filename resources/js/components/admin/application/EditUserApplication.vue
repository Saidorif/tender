    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="">
          <h4
            class="title_user"
            v-if="direction_ids.length > 0"
            v-for="(item, index) in direction_ids"
          >
            {{ index + 1 }}) {{ item.name }}
          </h4>
        </div>
        <div class="d-flex">
          ...
          <router-link
            class="btn btn-primary back_btn"
            to="/crm/user/application"
          >
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-12">
            <h2>
              <em>{{ $t("Tashkilot nomi") }}:</em>
              <b>{{ form.user ? form.user.company_name : "" }}</b>
            </h2>
          </div>
        </div>
        <div
          class="row"
          v-if="form.tarif && form.tarif.length"
          v-for="(item, index) in direction_ids"
        >
          <div class="col-md-3">
          ...
          <div class="form-group col-md-3">
            ...
            <div class="d-flex align-items-center">
              <input
                ...
                :class="
                  isRequiredData(form.tarif[index].summa) ? 'isRequired' : ''
                "
          ...
          <div class="form-group col-md-3">
            ...
            <input
              ...
              :class="
                isRequiredData(form.qty_reys[index].qty) ? 'isRequired' : ''
              "
              :disabled="makeDisabled"
            />
          </div>
          <div
            class="form-group col-md-3 btn_save d-flex justify-content-end"
            v-if="!makeDisabled"
          >
            <button
              type="button"
              ...
              <div class="table-responsive" v-if="direction_ids.length > 0">
                ...
                <div class="choosenItemsTable">
                  <ul v-for="(items, index) in direction_ids">
                    <h3>
                      <em>{{ index + 1 }})</em>
                      <strong>{{ $t("Marshrut") }}</strong
                      >: <em>{{ items.name }}</em>
                      <small
                        >({{
                          items.reys_status == "all"
                            ? $t("Toʼliq")
                            : $t("Qisman")
                        }})</small
                      >
                    ...
                    <template>
                      <li class="mb-2">
                        <h4>
                          <em>{{ $t("Tomonidan") }}:</em>
                          <b>{{ items.reysesFrom[0].where.name }}</b>
                        </h4>
                      ...
                      <li>
                        <h4>
                          <em>Со стороны:</em>
                          <b>{{ items.reysesTo[0].where.name }}</b>
                        </h4>
                        <table class="table table-bordered">
                          <thead>
                            <tr>
                              <th>№</th>
                              <th
                                v-for="(item, index) in items.reysesTo[0]
                                  .reys_times"
                                colspan="2"
                              >
                                {{ item.where.name }}
          ...
          <div class="row">
            <div class="form-group col-md-12 table table-responsive">
              <div class="d-flex justify-content-center">
                <h4 class="app_title">
                  {{
                    $t(
                      "Yoʼnalishlarda ishlayotganda harakatlanish xavfsizligini taʼminlash boʼyicha qatnashchi tomonidan amalga oshirilgan tadbirlar rejasi quyidagicha baholanadi"
                    )
                  }}
                </h4>
              </div>
                ...
                <thead>
                  <tr>
                    ...
                    <th width="50%">
                      {{
                        $t(
                          "Аvtotransport vositalarini xar kuni reysdan oldingi texnik koʼrikdan oʼtkazish uchun barcha sharoitlar yaratilgan"
                        )
                      }}
                    </th>
                    <th>
                  ...
                  <tr>
                    ...
                    <th width="50%">
                      {{
                        $t(
                          "Haydovchilarni har kungi tibbiy koʼrikdan oʼtkazish uchun barcha sharoitlar yaratilgan"
                        )
                      }}
                    </th>
                    <th>
                  ...
                  <tr>
                    ...
                    <th width="50%">
                      {{
                        $t(
                          "Taklif etilgan avtotransport vositalari sonidan kelib chiqib barcha haydovchilariga 30 soatlik dastur boʼyicha yoʼl harakati qoidalarini oʼrgatilgan"
                        )
                      }}
                    </th>
                    <th>
                  ...
                  <tr>
                    ...
                    <th width="50%">
                      {{
                        $t(
                          "Taklif etilgan barcha avtotransport vositalarining old oynalariga videoregistrator oʼrnatilgan"
                        )
                      }}
                    </th>
                    <th>
                  ...
                  <tr>
                    ...
                    <th width="50%">
                      {{
                        $t(
                          "Taklif etilgan barcha avtotransport vositalarini GPS rejimida masofadan kuzatish tizimiga ulangan"
                        )
                      }}
                    </th>
                    <th>
            ...
            <div class="form-group col-lg-12" v-if="form.hours_rule == 1">
              <div class="row pl-3">
                ...
                <div
                  class="input-group input_group_with_label input_file col-md-3"
                >
                  <input
                    type="file"
                    class="form-control"
                  ...
                  <p>{{ file ? file.name : "" }}</p>
                  <label for="file">
                    {{ $t("contacts_page.file_upload") }}</label
                  >
                </div>
            ...
            <div
              class="form-group col-md-12 table table-responsive"
              v-if="cars_with.length > 0"
            >
              <div class="d-flex justify-content-center">
                        ...
                        <table class="table table-bordered" v>
                          <thead>
                            <tr>
                              <th width="1%">1</th>
                              <th width="80%">
                                {{ $t("Sovutgich (iqlim-nazorati tizimi)") }}
                              </th>
                              <th>
                                <i
                            ...
                            <tr>
                              ...
                              <th>
                                <i
                                  class="fas text-success"
                                  :class="
                                    car.internet == 1 ? ' fa-check-circle' : ''
                                  "
                                ></i>
                              </th>
                            </tr>
                            ...
                            <tr>
                              ...
                              <th width="80%">
                                {{
                                  $t(
                                    "Аvtobusning nogironlarga va aholining boshqa xarakatlanishi cheklangan guruxlariga moslashganligi"
                                  )
                                }}
                              </th>
                              <th>
            ...
            >
              <div class="form-group col-md-3 mb-0" v-if="old_contract_time">
                ...
                <select class="form-control" v-model="contract_time">
                  <option
                    ...
                    :value="option.val"
                    v-if="old_contract_time >= option.val"
                  >
                    {{ option.name }}
                  </option>
                </select>
              ...
              <router-link
                :to="`/crm/application/user/${$route.params.userapplicationId}`"
                class="btn btn-secondary mr-3"
              >
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                >
                  ...
                  <option
                    :value="busClass.id"
                    v-for="(busClass, index) in getBusclassFindList"
                  >
                    {{ busClass.name }}
                  </option>
                </select>
              ...
              <div class="col-md-12" v-if="car.owner_type == 'owner'">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="pTexpassportSery">{{
                      $t("Texpasport seriyasi")
                    }}</label>
                    <input
                      type="text"
                      class="form-control input_style"
                      ...
                      :class="
                        isRequired(car.pTexpassportSery) ? 'isRequired' : ''
                      "
                    />
                  </div>
                  <div class="form-group col-md-6">
                    <label for="pTexpassportNumber">{{
                      $t("Texpasport raqami")
                    }}</label>
                    <input
                      type="number"
                      ...
                      :class="
                        isRequired(car.pTexpassportNumber) ? 'isRequired' : ''
                      "
                    />
                  </div>
                </div>
              ...
              <div class="col-md-12" v-if="car.owner_type == 'rent'">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="pNumberNatarius">{{
                      $t("Notarius hujjat reestr raqami")
                    }}</label>
                    <input
                      type="text"
                      class="form-control input_style"
                      ...
                      :class="
                        isRequired(car.pNumberNatarius) ? 'isRequired' : ''
                      "
                    />
                  </div>
                  <div class="form-group col-md-6">
                    <label for="pDateNatarius">{{
                      $t("Notarius hujjat sanasi")
                    }}</label>
                    <date-picker
                      lang="ru"
                      type="date"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-flex justify-content-center">
            <div class="qr_code_modal">
              <h4>
                <b> {{ $t("Sizning arizangiz qabul qilinadi") }}!</b>
              </h4>
              <div>
              ...
              <div>
                <b>{{ $t("Tender sanasi") }}:</b>
                {{ form.tender ? $g.getDate(form.tender.time) : "" }}
              </div>
              <div>
                <b>{{ $t("Manzil") }}:</b>
                {{ form.tender ? form.tender.address : "" }}
              </div>
              <div>
                <b>{{ $t("Tender vaqti") }}:</b>
                {{ form.tender ? $g.getTime(form.tender.time) : "" }}
              </div>
...
export default {
  ...
  async mounted() {
    ...
    if (this.getUserShowApp) {
      ...
      if (this.getUserShowApp.tarif) {
        this.form.tarif = this.getUserShowApp.tarif.length
          ? this.getUserShowApp.tarif
          : [];
      } else {
        this.form.tarif = [];
      }
      if (this.getUserShowApp.qty_reys) {
        this.form.qty_reys = this.getUserShowApp.qty_reys.length
          ? this.getUserShowApp.qty_reys
          : [];
      } else {
        this.form.qty_reys = [];
      }
  ...
  methods: {
    ...
    ...mapActions("busmodel", [
      "actionBusmodelList",
      "actionBusmodelListByBrand",
      "actionBusmodelFindList",
    ]),
    ...
    async saveData() {
      ...
      if (
        !this.requiredDataInput &&
        this.form.qty_reys != "" &&
        this.form.qty_reys != null
      ) {
        if (check) {
          this.laoding = true;
