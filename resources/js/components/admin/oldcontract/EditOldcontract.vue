<template>
	<div class="edit_oldcontract">
		<Loader v-if="laoding"/>
		<div class="card">
		  	<div class="card-header">
			    <h4 class="title_user">
			    	<i class="peIcon fas fa-file-alt"></i>
				    Изменить старый котракт
				</h4>
...
<script>
	...
	export default{
		...
		computed:{
			...mapGetters('oldcontract',['getMassage','getOldcontract'])
		},
		async mounted(){
		...
		methods:{
			...mapActions('oldcontract',['actionUpdateOldcontract','actionEditOldcontract']),
			isRequired(input){
