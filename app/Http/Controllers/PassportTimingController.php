    ...
    public function store(Request $request,$id)
    {
        ...
        foreach ($inputs as $key => $value) {
            $passportTiming = PassportTiming::create([
                ...
                'distance_from_start_station' => (float) $value['distance_from_start_station'],
                'distance_between_station' => (float) $value['distance_between_station'],
                'distance_in_limited_speed' => (float) $value['distance_in_limited_speed'],
                'spendtime_between_station' => (float) $value['spendtime_between_station'],
                'spendtime_between_limited_space' => (float) $value['spendtime_between_limited_space'],
                'spendtime_to_stay_station' => (float) $value['spendtime_to_stay_station'],
                'speed_between_station' => (float) $value['speed_between_station'],
                'speed_between_limited_space' => (float) $value['speed_between_limited_space'],
                'end_speedometer' => (float) $value['end_speedometer'],
                'start_speedometer' => (float) $value['start_speedometer'],
            ]);
        }
