		...
		<div class="card">
			  ...
			  <div class="table-responsive">
				<table class="table table-bordered text-center table-hover table-striped">
					...
					<tbody>
						<tr v-for="(reg,index) in getInvoices.data">
					...
					<pagination :limit="4" :data="getInvoices" @pagination-change-page="getResults"></pagination>
				</table>
			  </div>
		  </div>
	  	</div>
...
<script>
	...
	export default{
		...
		methods:{
			...mapActions('invoices',['actionInvoice']),
